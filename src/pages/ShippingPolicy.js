...
const ShippingPolicy = () => {
    return (
        <div style={{ width: '90%', margin: 'auto', marginTop: '20px' }}>
            <Typography style={{ ...textStyle, fontSize: 36, fontWeight: 700 }}>SHIPPING POLICY</Typography>
            <Typography style={textStyle} my={1}>
                We at Bloom By Khushbu, understand the importance of delivering your products in the finest condition and on time. Therefore, we have partnered with some of the most reputed courier partners in this country to seamlessly deliver your products in the best possible duration.
            </Typography>
            <Typography style={{ ...textStyle, fontSize: 25, fontWeight: 700 }} my={2}>DELIVERY</Typography>
            <Typography style={{ ...textStyle, fontWeight: 700 }} my={2}>A) How does the delivery process work?</Typography>
            <Typography style={textStyle} my={1}>
            ...
            <Typography style={textStyle} my={1}>We religiously aim to ship the products within 3-5 working days, however with the current COVID situation few order shipments might take longer than usual. Since few of the products are made-to-order, in few cases there might be some delays due to dependencies at various levels. Furthermore, We diligently ship orders throughout the week except Sunday and Monday.</Typography>
            <Typography style={textStyle} my={1}>Please note-During festivals, adverse weather conditions or political crisis, your shipment may get further delayed due to dependency on courier companies. We ensure you that we will try our best to have product delivered to you in the best time and we truly appreciate your patience.</Typography>
            <Typography style={{ ...textStyle, fontWeight: 700 }} my={2}>C) Can I track my order?</Typography>
            <Typography style={textStyle} my={1}>Yes, you sure can! Once your order is shipped, you will receive an email from Bloom By Khushbu with the tracking ID of the respective courier partner. You can simply click TRACK ORDER and enter your order number or full AWB to check where your order has reached or how long will it take to get delivered.</Typography>
            <Typography style={{ ...textStyle, fontSize: 25, fontWeight: 700 }} my={2}>DOMESTIC SHIPPING</Typography>
            <Typography style={{ ...textStyle, fontWeight: 700 }} my={2}>A) Do you provide shipping all over the India?</Typography>
            <Typography style={textStyle} my={1}>Yes.</Typography>
            <Typography style={{ ...textStyle, fontWeight: 700 }} my={2}>B) Which locations do you ship your products?</Typography>
            <Typography style={textStyle} my={1}>Bloom By Khushbu ships throughout India so you can receive your order in any corner of the country within the confines of your home.</Typography>
