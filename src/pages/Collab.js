import { Button, Checkbox, FormControlLabel, Grid, LinearProgress, Paper, TextField, Typography } from "@mui/material";
        ...
        <>
            <FormikProvider value={formik}>
                <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
                    <DoubleText frontTextTopDistance={window.innerWidth < 500 ? "8vw" : '5.5vw'} backTextFontSize={window.innerWidth < 500 ? '12vw' : "8vw"} frontTextFontSize={window.innerWidth < 500 ? '4vw' : "3.2vw"} frontText="COLLABORATE WITH US" underline={false} frontTextFontFamily="Poppins" backText="Get in Touch" marginTop='1vw' />
