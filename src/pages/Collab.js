        ...
        <>
            <FormikProvider value={formik}>
                <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
                    <DoubleText frontTextTopDistance='1vw' backTextFontSize={window.innerWidth < 500 ? '12vw' : "8vw"} frontTextFontSize={window.innerWidth < 500 ? '4vw' : "3.2vw"} frontText="COLLABORATE WITH US" underline={false} frontTextFontFamily="Poppins" backText="" marginTop='1vw' />
