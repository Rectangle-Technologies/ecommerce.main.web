...
const Landing = (props) => {
  ...
  return (
    <>
      {/* <Caraousel /> */}
      <DoubleTextComponent backTextFontSize={window.innerWidth < 500 ? '9.5vw' : '8vw'} frontTextFontSize={window.innerWidth < 500 ? '5vw' : '3.5vw'} frontTextTopDistance={window.innerWidth < 500 ? '0vw' : '0vw'} backText="" frontText="New Arrivals" marginTop='1.5vw' />
      ...
      <DoubleTextComponent backTextFontSize={window.innerWidth < 500 ? '9.5vw' : '8vw'} frontTextFontSize={window.innerWidth < 500 ? '5vw' : '3.5vw'} frontTextTopDistance={window.innerWidth < 500 ? '0vw' : '0vw'} backText="" frontText="Categories" marginTop='1.5vw' />
